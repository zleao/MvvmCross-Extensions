...
namespace Playground.iOS
{
    ...
    public partial class NavigationViewController : ViewControllerBase<NavigationViewModel>
    {
        ...
        public override void ViewDidLoad()
        {
            ...
            set.Bind(LabelNavigateAndRemoveSelf).To(vm => vm.TextSource).WithConversion<MvxLanguageConverter>(TextResourcesKeys.Text_Description_NavigateAndRemoveSelf);
            ...
            set.Bind(LabelNavigate).To(vm => vm.TextSource).WithConversion<MvxLanguageConverter>(TextResourcesKeys.Text_Description_Navigate);
