...
namespace MvvmCrossUtilities.Libraries.Droid.Bindings.Views.DragSortListView
{
    ...
    public class DragSortController : SimpleFloatViewManager, View.IOnTouchListener, GestureDetector.IOnGestureListener
    {
        ...
        private AbstractDragSortListView _dslv;
        ...
        public DragSortController(AbstractDragSortListView dslv)
            : this(dslv, 0, DragInitModeEnum.OnDown, RemoveModeEnum.FlingRemove)
        {
        }

        public DragSortController(AbstractDragSortListView dslv, int dragHandleId, DragInitModeEnum dragInitMode, RemoveModeEnum removeMode)
            : this(dslv, dragHandleId, dragInitMode, removeMode, 0)
        {
        }

        public DragSortController(AbstractDragSortListView dslv, int dragHandleId, DragInitModeEnum dragInitMode, RemoveModeEnum removeMode, int clickRemoveId)
        ...
        public DragSortController(AbstractDragSortListView dslv, int dragHandleId, DragInitModeEnum dragInitMode, RemoveModeEnum removeMode, int clickRemoveId, int flingHandleId)
            : base(dslv)
        {
            _dslv = dslv;
        ...
        public bool StartDrag(int position, int deltaX, int deltaY)
        {
            ...
            {
                dragFlags |= AbstractDragSortListView.DRAG_POS_Y | AbstractDragSortListView.DRAG_NEG_Y;
            }
            if (_removeEnabled && _isRemoving)
            {
                dragFlags |= AbstractDragSortListView.DRAG_POS_X;
                dragFlags |= AbstractDragSortListView.DRAG_NEG_X;
            }
        ...
        internal class FlingListener : Java.Lang.Object, GestureDetector.IOnGestureListener
        {
            ...
            private readonly DragSortController _dsc;
            ...
            public FlingListener(DragSortController dsc, AbstractDragSortListView dslv)
            {
                _dsc = dsc;
                _dslv = dslv;
            }
