...
{
    public class FragmentViewPagerStateAdapter : FragmentStatePagerAdapter, IPagerAdapter
    {
        ...
        public FragmentViewPagerStateAdapter(Android.Support.V4.App.FragmentManager fragmentManager, int itemTemplateId)
            : this(fragmentManager, itemTemplateId, MvxAndroidBindingContextHelpers.Current())
        {
        }

        public FragmentViewPagerStateAdapter(Android.Support.V4.App.FragmentManager fragmentManager, int itemTemplateId, IMvxAndroidBindingContext bindingContext)
            : base(fragmentManager)
        {
            _bindingContext = bindingContext;
            if (_bindingContext == null)
                throw new MvxException("FragmentViewPagerStateAdapter can only be used within a Context which supports IMvxBindingActivity");
