...
namespace MvxExtensions.Libraries.Droid.Core.Support.V7.Components.Controls.DragSortListView.Runnables
{
    ...
    /// </summary>
    partial class AppCompatDropAnimator : AppCompatSmoothAnimator
    {
        #region Fields
        ...
        public AppCompatDropAnimator(AppCompatBaseDragSortListView dslv, float smoothness, int duration)
        ...
        public override void OnStart()
        {
            ...
            _dslv.DragState = DragStateEnum.Dropping;
