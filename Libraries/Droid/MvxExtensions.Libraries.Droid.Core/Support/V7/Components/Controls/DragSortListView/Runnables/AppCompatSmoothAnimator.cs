...
{
    class AppCompatSmoothAnimator : Java.Lang.Object, IRunnable
    {
        #region Fields
        ...
        protected readonly AppCompatBaseDragSortListView _dslv;

        #endregion

        #region Constructor

        public AppCompatSmoothAnimator(AppCompatBaseDragSortListView dslv, float smoothness, int duration)
        {
            if (dslv == null)
