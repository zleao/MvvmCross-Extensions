...
{
    public class AppCompatTreeViewItem 
        : LinearLayoutCompat
        , ITreeViewItem
        , IMvxBindingContextOwner
    {
        ...
        public AppCompatTreeViewItem(Context context, IMvxLayoutInflaterHolder layoutInflater, object dataContext, int templateId)
            : base(context)
        {
