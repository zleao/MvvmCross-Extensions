...
{
    public abstract class BaseTreeViewAdapter<T> : BaseAdapter, IListAdapter, Android.Views.View.IOnClickListener
        where T : class, Portable.Core.Models.ITreeViewItem
    {
        ...
        private readonly string TAG = "BaseTreeViewAdapter";
        ...
        public BaseTreeViewAdapter(Context context, ITreeStateManager<T> treeStateManager, int numberOfLevels, int itemTemplateId)
            : this(context, MvxAndroidBindingContextHelpers.Current(), treeStateManager, numberOfLevels, itemTemplateId)
        {
        }

        public BaseTreeViewAdapter(Context context, IMvxAndroidBindingContext bindingContext, ITreeStateManager<T> treeStateManager, int numberOfLevels, int itemTemplateId)
        {
        ...
        public override View GetView(int position, View convertView, ViewGroup parent)
        {
            ...
            var bindableViewToUse = convertView as Controls.TreeView.ITreeViewItem;
            ...
            {
                newChild = true;
                bindableViewToUse = new AppCompatTreeViewItem(Context, BindingContext.LayoutInflaterHolder, dataContext, GetTreeListItemWrapperId());
            }
            else
            {
            ...
            return PopulateTreeItem(bindableViewToUse as AppCompatTreeViewItem, nodeInfo, newChild);
        }
        ...
        public View PopulateTreeItem(AppCompatTreeViewItem bindableView, TreeNodeInfo<T> nodeInfo, bool newChildView)
        {
            ...
            LinearLayoutCompat.LayoutParams indicatorLayoutParams = new LinearLayoutCompat.LayoutParams(CalculateIndentation(nodeInfo), ViewGroup.LayoutParams.MatchParent);
        ...
        private Drawable GetDrawableOrDefaultBackground(Drawable r)
        {
            if (r == null)
            {
                return ContextCompat.GetDrawable(Context, Resource.Drawable.list_selector_background).Mutate();
            }
            else
            {
                return r;
        ...
        {
            var bindableView = v as AppCompatTreeViewItem;
            ...
            else
            {
                ...
                if (imageView != null && imageView.Parent != null)
                {
                    ...
                    var bindableListItem = imageView.Parent.Parent as AppCompatTreeViewItem;
