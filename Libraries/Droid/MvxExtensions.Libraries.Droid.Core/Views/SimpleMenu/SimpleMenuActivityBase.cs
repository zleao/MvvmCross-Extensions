...
namespace MvxExtensions.Libraries.Droid.Core.Views.SimpleMenu
{
    class SimpleMenuActivityBase
    {
    }
    public abstract class SimpleMenuActivityBase<TViewModel> : ActivityBase<TViewModel>
