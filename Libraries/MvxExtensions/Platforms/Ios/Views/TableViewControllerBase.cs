...
{
    public abstract class TableViewControllerBase<TViewModel> : MvxTableViewController<TViewModel>
        where TViewModel : ViewModel
    {
        ...
        public TableViewControllerBase(UITableViewStyle style = UITableViewStyle.Plain)
        {
        }

        public TableViewControllerBase(IntPtr handle)
            : base(handle)
        {
        }

        protected TableViewControllerBase(string nibName, NSBundle bundle)
            : base(nibName, bundle)
        {
        }
